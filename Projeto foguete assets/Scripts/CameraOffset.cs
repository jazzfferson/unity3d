...
public class CameraOffset : MonoBehaviour {
	...
	void LateUpdate () {
        ...
        if (follow)
        {
            ...
            transform.position = Vector2.Lerp(cameraPosition, targetPosition, Time.smoothDeltaTime * damp);
        }
        else
        {
            transform.position = Vector2.Lerp(cameraPosition, posicaoOriginal, Time.smoothDeltaTime * 2);
        }
