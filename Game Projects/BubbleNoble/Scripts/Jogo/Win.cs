...
public class Win : MonoBehaviour {
	...
	IEnumerator StartAnimation(bool newLevelUnlocked)
	{
		...
		StarsEarned(Fases.leveis[Fases.faseAtual].LastScore);
	...
	string randPhrase()
	{
		...
		if(Fases.leveis[Fases.faseAtual].LastScore == 3)
		{
		...
		else if(Fases.leveis[Fases.faseAtual].LastScore == 2)
		{
		...
		else if(Fases.leveis[Fases.faseAtual].LastScore == 1)
		{
	...
	void PlayParticles()
	{
        ...
        //Som do tiro dos confetes
		Instanciador.instancia.PlaySfx(7,0.2f,1f);
		indexParticulas++;
